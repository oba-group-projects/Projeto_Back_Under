...
const BLOCOS_JUSTO_1 = [
  { justo: 7.0, topo: 8.8, fundo: 7.8 },
  { justo: 6.5, topo: 8.0, fundo: 7.2 },
  { justo: 6.0, topo: 7.4, fundo: 6.6 },
  { justo: 5.5, topo: 6.8, fundo: 5.9 },
  { justo: 5.0, topo: 6.0, fundo: 5.3 },
  { justo: 4.5, topo: 5.4, fundo: 5.0 },
  { justo: 4.33, topo: 5.1, fundo: 4.6 },
  { justo: 4.0, topo: 4.7, fundo: 4.0 },
  { justo: 3.5, topo: 4.1, fundo: 3.85 },
  { justo: 3.4, topo: 3.9, fundo: 3.65 },
  { justo: 3.25, topo: 3.7, fundo: 3.35 },
  { justo: 3.0, topo: 3.4, fundo: 3.05 },
  { justo: 2.75, topo: 3.1, fundo: 2.9 },
  { justo: 2.62, topo: 2.92, fundo: 2.76 },
  { justo: 2.5, topo: 2.78, fundo: 2.6 },
  { justo: 2.37, topo: 2.62, fundo: 2.44 },
  { justo: 2.25, topo: 2.46, fundo: 2.38 },
  { justo: 2.2, topo: 2.4, fundo: 2.26 },
  { justo: 2.1, topo: 2.28, fundo: 2.14 },
  { justo: 2.0, topo: 2.16, fundo: 2.02 },
  { justo: 1.9, topo: 2.04, fundo: 1.95 },
  { justo: 1.83, topo: 1.96, fundo: 1.92 },
  { justo: 1.8, topo: 1.93, fundo: 1.82 },
  { justo: 1.72, topo: 1.83, fundo: 1.75 },
  { justo: 1.66, topo: 1.76, fundo: 1.69 },
  { justo: 1.61, topo: 1.7, fundo: 1.64 },
  { justo: 1.57, topo: 1.65, fundo: 1.6 },
  { justo: 1.53, topo: 1.61, fundo: 1.56 },
  { justo: 1.5, topo: 1.57, fundo: 1.49 },
  { justo: 1.2, topo: 1.2, fundo: 1.14 },
];

const BLOCOS_JUSTO_2 = [
  { justo: 7.0, topo: 8.6, fundo: 7.8 },
  { justo: 6.5, topo: 8.0, fundo: 7.2 },
  { justo: 6.0, topo: 7.4, fundo: 6.4 },
  { justo: 5.5, topo: 6.6, fundo: 5.9 },
  { justo: 5.0, topo: 6.0, fundo: 5.3 },
  { justo: 4.5, topo: 5.4, fundo: 5.0 },
  { justo: 4.33, topo: 5.1, fundo: 4.6 },
  { justo: 4.0, topo: 4.7, fundo: 3.95 },
  { justo: 3.5, topo: 4.0, fundo: 3.8 },
  { justo: 3.4, topo: 3.85, fundo: 3.6 },
  { justo: 3.25, topo: 3.6, fundo: 3.3 },
  { justo: 3.0, topo: 3.35, fundo: 3.05 },
  { justo: 2.75, topo: 3.1, fundo: 2.9 },
  { justo: 2.62, topo: 2.92, fundo: 2.72 },
  { justo: 2.5, topo: 2.74, fundo: 2.6 },
  { justo: 2.37, topo: 2.6, fundo: 2.48 },
  { justo: 2.25, topo: 2.48, fundo: 2.4 },
  { justo: 2.2, topo: 2.4, fundo: 2.28 },
  { justo: 2.1, topo: 2.3, fundo: 2.18 },
  { justo: 2.0, topo: 2.18, fundo: 2.06 },
  { justo: 1.9, topo: 2.06, fundo: 2.0 },
  { justo: 1.83, topo: 2.0, fundo: 1.94 },
  { justo: 1.8, topo: 1.94, fundo: 1.85 },
...
function runDemo() {
  ...
  console.log('HT inicial:', {
    minute: ht.realMinute,
    maxMinute: ht.maxMinute,
    curveLength: ht.curve.length,
  });
  for (let i = 0; i < 60; i++) {
    if (!ht.timerRunning) break;
    ht.tick();
  }
  console.log('HT após avanço forçado:', {
    minute: ht.realMinute,
    timerRunning: ht.timerRunning,
    maxMinute: ht.maxMinute,
  });

  console.log('\n2) ACRÉSCIMOS: sincronização ativa a regra somente após os 45/90 minutos');
  const ft = new MatchLogic({ period: 'FT', initialOdd: 5.1, addedMinutes: 5 });
  ft.setAddedMinutes(7);
  console.log('FT pendente:', {
    pending: ft.pendingAddedMinutes,
    currentMax: ft.maxMinute,
    lastMinute: ft.getMinuteMetricsFor(90).oddJusta,
  });
  ft.syncAddedMinutes();
  console.log('FT após sync:', {
    addedMinutes: ft.addedMinutes,
    maxMinute: ft.maxMinute,
    minute90: ft.getMinuteMetricsFor(90).oddJusta,
    minute97: ft.getMinuteMetricsFor(97).oddJusta,
  });

  console.log(
    '\n3) SIMULAÇÃO FUTURA: o relógio real continua em 30 enquanto a projeção vai para 40'
  );
  const live = new MatchLogic({ period: 'FT', initialOdd: 5.1, addedMinutes: 5 });
  live.realMinute = 30;
  ...
  console.log(
    'Projeção para 40:',
    live.projectedMinute,
    '->',
    live.projectedMetrics.oddJusta,
    'bloco1',
    live.projectedMetrics.bloco1,
    'bloco2',
    live.projectedMetrics.bloco2
  );
  console.log('Status real:', {
    realMinute: live.realMinute,
    projectedMinute: live.projectedMinute,
    realChanged: false,
    projectedOnly: true,
  });
  ...
  const row = eventSlot.registerEvent(43, 1.6);
  console.log('Registro:', row);

  console.log('\n5) BLOCOS JUSTOS: abaixo de 1.60 continuam aplicados');
  const oddsToCheck = [1.7, 1.6, 1.57, 1.53, 1.45, 1.15];
  for (const odd of oddsToCheck) {
    const bloco1 = lookupBloco(odd, BLOCOS_JUSTO_1);
    const bloco2 = lookupBloco(odd, BLOCOS_JUSTO_2);
    console.log(
      `odd ${odd.toFixed(2)} => bloco1 ${bloco1.topo.toFixed(2)} / ${bloco1.fundo.toFixed(2)} | bloco2 ${bloco2.topo.toFixed(2)} / ${bloco2.fundo.toFixed(2)}`
    );
  }

  console.log('\n6) VERIFICAÇÃO FINAL DO CRONOMETRO E CURVA');
  const finalCheck = new MatchLogic({ period: 'HT', initialOdd: 3.35, addedMinutes: 2 });
  console.log('Fim HT esperado:', {
    maxMinute: finalCheck.maxMinute,
    lastMinute: finalCheck.curve[finalCheck.curve.length - 1].minute,
    lastOdd: finalCheck.curve[finalCheck.curve.length - 1].oddJusta,
  });
